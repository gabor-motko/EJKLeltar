namespace EJKLeltar
{
	partial class ChangeQuantityForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.cancelButton.Location = new System.Drawing.Point(265, 107);
			...
			// changeNumber
			// 
			this.changeNumber.Location = new System.Drawing.Point(12, 61);
			this.changeNumber.Maximum = new decimal(new int[] {
            10000,
            0,
            0,
            0});
			this.changeNumber.Name = "changeNumber";
			this.changeNumber.Size = new System.Drawing.Size(111, 20);
			this.changeNumber.TabIndex = 1;
			// 
			// label1
			// 
